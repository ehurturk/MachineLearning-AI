...
X_, y = LinearRegression.generate_dataset(samples=400, features=1, seed=3433) # Generating a dataset with 100 samples with only 1 feature with a random seed 1
